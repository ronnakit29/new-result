...
export default function Home() {
    ...
    const [proxyServers, setProxyServers] = React.useState([
        "http://165.22.244.162:9988",
        "http://165.22.255.233:9988",
        "http://134.209.96.21:9988",
    ])
    ...
    async function getGameUrl(username, gameCode) {
        const url = `${process.env.NEXT_PUBLIC_MAIN_URL}/user/login`;
        const data = {
            username,
            gameCode,
        };
    ...
    async function getGames() {
        const url = `${process.env.NEXT_PUBLIC_MAIN_URL}/user/games`;
